...
public class AccountHolderSceneController implements Initializable {
    ...
    private void addCustomer(ActionEvent event) {
       ...
       if(!update){
            ...
            ResultSet rs= QueryDatabase.query("Select Count(Id) from accounttable where BCode ='"+branchCode+"';");
            if(rs==null){
            accNumber = branchCode+"10001";
            }else{
                if(rs.next()){
                    int id = Integer.parseInt(rs.getString(1));
                    id++;
                    id +=10000;
                    accNumber = branchCode+id;
                }else{
                     accNumber = branchCode+"10001";
                     }
            ...
            String query = "INSERT INTO accounttable (Account_Number,Account_Type,BCode,Name,Gender,Dob,Address,CitizenID,Balance)VALUES("+
                           "'"+accNumber+"',\n" +"'"+accType+"',\n" +"'"+branchCode+"',\n" + "'"+name+"',\n" +"'"+gender+"',\n" +"'"+dateofbirth+"',\n" +
                           "'"+address+"',\n" + "'"+citizenID+"',\n" + "'"+balance+"');";                    
            ...
            String query = "Update accounttable set Account_Type='"+accType+"',BCode='"+branchCode+"',Name='"+name+"',"
                       + "Gender='"+gender+"',Dob='"+dateofbirth+"',Address='"+address+"',CitizenID='"+citizenID+"' Where Id='"+id+"';";
